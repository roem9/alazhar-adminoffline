...
<body lang="ar">
    ...
    <div class="nama">
        <p style="text-align: center; font-size: 26px"><strong><?= $peserta['nama_arab']?></strong></p>
    </div>
    <!-- <div class="ttl">
    ...
    <!-- <div class="pr4">
        <div style="text-align: center; font-size: 22px">الشفوية و التحريرية نجاحا بتقدير عام : <i><u><b><?= $syahadah['nilai']?></b></u></i></div>
    </div> -->
    <!-- <div class="pr5">
        <div style="text-align: center; font-size: 22px">سجلت هذه الشهادة برقم دفتر القيد : <b><?= $syahadah['nomor']?></b></div>
    </div> -->
    <!-- <div class="pr6">
